...
> &#8195;&#8195;这是一个ghost博客的插件，能让你的文章使用指定的中文字体！而且是精简过的！目前呢，1000字的文章生成的ttf字体在600K左右（要看重复字数的多少），以后还有很大优化的空间。
...
说下目前很严重的几个问题  
 ...
      4. 用的字体处理是FontMin，对OTF的支持不是很好，有些TTF也不支持，使用之前可以测试一下。
      5. 现在就只能用TTF，没写其他字体，朋友们只能将就用了，或者自强一点，去改改。   
